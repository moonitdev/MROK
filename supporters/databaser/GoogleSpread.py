...
class GoogleSpread:
    ...
    def open_url(self, url=''):
        ...
        입력:
            - 변수명 || 의미 | 데이터 타입 | 디폴트값 | 예시
            - url || google spread 파일 url 이름[self.urls의 key값] || str | 'Coin_Exchanges' | 'Coin_Exchanges'
        Note:
            - 
        """
    ...
    def get_dicts_from_sheet(self, url='Coin_Exchanges', sheet='test', header=0):
        """
    ...
    def write_sheet(self, url='Coin_Exchanges', sheet='test', dicts=[{}], data_type='dicts', new=False):
        """
